...
exports.registerUser = async function(attributes) {
  ...
  try {
    ...
    if (hospitalId === 1) {
      const ccp = buildCCPHosp1();
      const caClient = buildCAClient(FabricCAServices, ccp, 'ca.hosp1.titanium.com');
      ...
      const caClient = buildCAClient(FabricCAServices, ccp, 'ca.hosp2.titanium.com');
      ...
      const caClient = buildCAClient(FabricCAServices, ccp, 'ca.hosp3.titanium.com');
...
exports.getAllDoctorsByHospitalId = async function(networkObj, hospitalId) {
  ...
  try {
    ...
    if (hospitalId === 1) {
      const ccp = buildCCPHosp1();
      caClient = buildCAClient(FabricCAServices, ccp, 'ca.hosp1.titanium.com');
    } else if (hospitalId === 2) {
      const ccp = buildCCPHosp2();
      caClient = buildCAClient(FabricCAServices, ccp, 'ca.hosp2.titanium.com');
    } else if (hospitalId === 3) {
      const ccp = buildCCPHosp3();
      caClient = buildCAClient(FabricCAServices, ccp, 'ca.hosp3.titanium.com');
    }

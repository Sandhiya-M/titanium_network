...
function networkDown() {
  ...
  docker-compose --env-file ./.env -f $COMPOSE_FILE_COUCH_ORG3 -f $COMPOSE_FILE_ORG3 down --volumes --remove-orphans
...
CLI_DELAY=3
# channel name defaults to "hospitalchannel"
CHANNEL_NAME="hospitalchannel"
# chaincode name defaults to "pateint"
CC_NAME="patient"

...
set -x
jq -s '.[0] * {"channel_group":{"groups":{"Application":{"groups": {"hosp3MSP":.[1]}}}}}' config.json ./organizations/peerOrganizations/hosp3.titanium.com/hosp3.json > modified_config.json
{ set +x; } 2>/dev/null
